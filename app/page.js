      ...
      <main className="min-h-dvh">
        ...
        <section id="hero" className="hero-section w-full flex flex-col justify-center items-center p-8 md:p-16 pt-0 relative h-[90dvh] overflow-hidden">
          <div className="title-wrapper flex flex-col justify-center items-center gap-4 sm:gap-6 overflow-hidden">
            ...
            <p className="headline text-xs sm:text-base max-w-xs sm:max-w-md text-center text-gray-500 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: info.headline }}></p>
            <CustomModal/>
          </div>
          <div className="mt-20 text-xs tracking-wide text-slate-400 text-center">! Theme doesn&apos;t work 100% correctly at the moment, I&apos;m trying to fix it ASAP !</div>
        ...
        {/* <section className="blogs-section home-section h-max">
          <CustomHeader header={"Blogs"} subheader={"Read what I shared!"}/>
          <div className="container-wrapper w-full flex flex-col items-center gap-4 md:gap-8">
            <BlogsList/>
            <CustomLink label={"Read on Medium"} href={"https://medium.com/@vireaksok"} download={false}/>
          </div>
        </section> */}
        <section className="contact-section home-section relative">
