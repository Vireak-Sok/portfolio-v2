    ...
    <main>
      ...
      <section className="all-works w-full py-8 px-4 sm:p-8 lg:p-16 flex flex-col items-start justify-center gap-4 sm:gap-8 lg:gap-16">
        ...
        <div className='table-conatianer w-full'>
          <div className='table-header-grid w-full grid grid-cols-3 lg:grid-cols-7 gap-4 text-md font-semibold py-4 border-b border-b-slate-500 md:px-4 bg-slate-50 dark:bg-slate-80 sticky top-0 z-10 theme-bg theme-tx'>
